...
function _ApproveEntryFee(objectName, callback, stakeAmount) {
 ...
 window.dispatchReactUnityEvent("ApproveEntryFee", parsedCallback, parsedObjectName, parsedStakeAmount);
}

function _ConnectToWallet(objectName, callback) {
 var parsedObjectName = Pointer_stringify(objectName);
 var parsedCallback = Pointer_stringify(callback);
 console.log("parsedObjectName: " + parsedObjectName + ", parsedCallback" + parsedCallback);
 window.dispatchReactUnityEvent("ConnectToWallet", parsedCallback, parsedObjectName);
}
...
function _StakeEntryFee(objectName, callback, stakeAmount) {
 var parsedObjectName = Pointer_stringify(objectName);
 var parsedCallback = Pointer_stringify(callback);
 var parsedStakeAmount = Pointer_stringify(stakeAmount);
 console.log("parsedObjectName: " + parsedObjectName + ", parsedCallback" + parsedCallback);
 window.dispatchReactUnityEvent("StakeEntryFee", parsedCallback, parsedObjectName, parsedStakeAmount);
}
...
var asmLibraryArg = {
 "ApproveEntryFee": _ApproveEntryFee,
 "ConnectToWallet": _ConnectToWallet,
 "IsMobileJS": _IsMobileJS,
